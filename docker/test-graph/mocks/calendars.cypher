...
// ##############################
MERGE (u:User { id: 'satoshi1234567890abcdefghijklmnopqrstuvwxyz123' }) SET u.name = "Satoshi Nakamoto", u.bio = "Bitcoin creator", u.status = "active", u.indexed_at = 1698753600000, u.links = "[]";

MERGE (u:User { id: 'halfinn1234567890abcdefghijklmnopqrstuvwxyz123' }) SET u.name = "Hal Finney", u.bio = "Cryptographer", u.status = "active", u.indexed_at = 1698753600000, u.links = "[]";

MERGE (u:User { id: 'adamback1234567890abcdefghijklmnopqrstuvwxyz12' }) SET u.name = "Adam Back", u.bio = "Hashcash inventor", u.status = "active", u.indexed_at = 1698753600000, u.links = "[]";
...
MERGE (c1:Calendar { id: "0033RCZXVEPNG" })
 SET c1.uri = "pubky://satoshi1234567890abcdefghijklmnopqrstuvwxyz123/pub/pubky.app/calendars/0033RCZXVEPNG",
...
MATCH (author:User { id: 'satoshi1234567890abcdefghijklmnopqrstuvwxyz123' }), (cal:Calendar {id: "0033RCZXVEPNG"})
MERGE (author)-[:AUTHORED]->(cal);

// Create ADMIN relationships
MATCH (admin:User { id: 'adamback1234567890abcdefghijklmnopqrstuvwxyz12' }), (cal:Calendar {id: "0033RCZXVEPNG"})
MERGE (admin)-[:ADMIN { indexed_at: 1698753600000 }]->(cal);

MATCH (admin:User { id: 'emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy' }), (cal:Calendar {id: "0033RCZXVEPNG"})
MERGE (admin)-[:ADMIN { indexed_at: 1698753600000 }]->(cal);

// Calendar 2: Lightning Network Meetups (by Hal, admin: detroit)
MERGE (c2:Calendar { id: "0033RDZXVEPNG" })
 SET c2.uri = "pubky://halfinn1234567890abcdefghijklmnopqrstuvwxyz123/pub/pubky.app/calendars/0033RDZXVEPNG",
...
MATCH (author:User { id: 'halfinn1234567890abcdefghijklmnopqrstuvwxyz123' }), (cal:Calendar {id: "0033RDZXVEPNG"})
MERGE (author)-[:AUTHORED]->(cal);

MATCH (admin:User { id: '7w4hmktqa7gia5thmk7zki8px7ttwpwjtgaaaou4tbqx64re8d1o' }), (cal:Calendar {id: "0033RDZXVEPNG"})
MERGE (admin)-[:ADMIN { indexed_at: 1698753600000 }]->(cal);

// Calendar 3: Pubky Developer Events (by Amsterdam, no additional admins)
MERGE (c3:Calendar { id: "0033REZXVEPNG" })
 SET c3.uri = "pubky://emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy/pub/pubky.app/calendars/0033REZXVEPNG",
...
MATCH (author:User { id: 'emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy' }), (cal:Calendar {id: "0033REZXVEPNG"})
MERGE (author)-[:AUTHORED]->(cal);

// Calendar 4: Crypto Community Calendar (by Bogota, admins: cairo, eixample)
MERGE (c4:Calendar { id: "0033RFZXVEPNG" })
 SET c4.uri = "pubky://ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny/pub/pubky.app/calendars/0033RFZXVEPNG",
...
MATCH (author:User { id: 'ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny' }), (cal:Calendar {id: "0033RFZXVEPNG"})
MERGE (author)-[:AUTHORED]->(cal);

MATCH (admin:User { id: 'f5tcy5gtgzshipr6pag6cn9uski3s8tjare7wd3n7enmyokgjk1o' }), (cal:Calendar {id: "0033RFZXVEPNG"})
MERGE (admin)-[:ADMIN { indexed_at: 1699100000000 }]->(cal);

MATCH (admin:User { id: '8attbeo9ftu5nztqkcfw3gydksehr7jbspgfi64u4h8eo5e7dbiy' }), (cal:Calendar {id: "0033RFZXVEPNG"})
MERGE (admin)-[:ADMIN { indexed_at: 1699100000000 }]->(cal);
...
e1.dtstart = "2024-10-31T19:00:00",
e1.dtend = "2024-10-31T22:00:00",
e1.summary = "Bitcoin Meetup Zürich",
e1.status = "CONFIRMED",
e1.dtstart_tzid = "Europe/Zurich",
e1.dtend_tzid = "Europe/Zurich",
...
e1.geo = "47.366667;8.550000",
e1.styled_description = null,
e1.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'satoshi1234567890abcdefghijklmnopqrstuvwxyz123' }), (event:Event {id: "0033SCZXVEPNG"})
...
e2.dtstart = "2024-11-05T14:00:00",
e2.dtend = "2024-11-05T18:00:00",
e2.summary = "Lightning Network Workshop",
e2.status = "CONFIRMED",
e2.dtstart_tzid = "Europe/Zurich",
e2.dtend_tzid = "Europe/Zurich",
...
e2.geo = "47.370000;8.545000",
e2.styled_description = null,
e2.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'halfinn1234567890abcdefghijklmnopqrstuvwxyz123' }), (event:Event {id: "0033SDZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
e3.dtstart = "2025-01-15T09:00:00",
e3.dtend = "2025-01-16T18:00:00",
e3.summary = "Bitcoin Conference 2025",
e3.status = "CONFIRMED",
e3.dtstart_tzid = "Europe/Zurich",
e3.dtend_tzid = "Europe/Zurich",
...
e3.geo = "47.366667;8.543333",
e3.styled_description = null,
e3.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'adamback1234567890abcdefghijklmnopqrstuvwxyz12' }), (event:Event {id: "0033SEZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
e4.dtstart = "2024-11-15T10:00:00",
e4.dtend = "2024-11-17T18:00:00",
e4.summary = "Pubky Hackathon 2024",
e4.status = "CONFIRMED",
e4.dtstart_tzid = "America/New_York",
e4.dtend_tzid = "America/New_York",
...
e4.geo = "40.712776;-74.005974",
e4.styled_description = null,
e4.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy' }), (event:Event {id: "0033SFZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
e5.dtstart = "2024-12-01T15:00:00",
e5.dtend = "2024-12-01T17:00:00",
e5.summary = "Weekly Crypto Standup",
e5.status = "CONFIRMED",
e5.dtstart_tzid = "America/New_York",
e5.dtend_tzid = "America/New_York",
...
e5.geo = "4.710989;-74.072092",
e5.styled_description = null,
e5.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny' }), (event:Event {id: "0033SGZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
e6.dtstart = "2024-12-10T18:00:00",
e6.dtend = "2024-12-10T20:00:00",
e6.summary = "Unauthorized Event - Should Fail Validation",
e6.status = "TENTATIVE",
e6.dtstart_tzid = "Europe/Zurich",
e6.dtend_tzid = "Europe/Zurich",
...
e6.geo = null ,
e6.styled_description = null,
e6.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'f5tcy5gtgzshipr6pag6cn9uski3s8tjare7wd3n7enmyokgjk1o' }), (event:Event {id: "0033SHZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
e7.dtstart = "2024-11-07T14:00:00",
e7.dtend = "2024-11-07T16:00:00",
e7.summary = "Special Crypto Workshop",
e7.status = "CONFIRMED",
e7.dtstart_tzid = "America/New_York",
e7.dtend_tzid = "America/New_York",
...
e7.geo = "4.710989;-74.072092",
e7.styled_description = null,
e7.x_pubky_rsvp_access = "PUBLIC";

MATCH (author:User { id: 'ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny' }), (event:Event {id: "0033SJZXVEPNG"})
MERGE (author)-[:AUTHORED]->(event);
...
MATCH (author:User { id: 'emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy' }), (attendee:Attendee {id: "0033UCZXVEPNG"})
...
MATCH (author:User { id: 'ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny' }), (attendee:Attendee {id: "0033UDZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: '7w4hmktqa7gia5thmk7zki8px7ttwpwjtgaaaou4tbqx64re8d1o' }), (attendee:Attendee {id: "0033UEZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: '7w4hmktqa7gia5thmk7zki8px7ttwpwjtgaaaou4tbqx64re8d1o' }), (attendee:Attendee {id: "0033UFZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: '8attbeo9ftu5nztqkcfw3gydksehr7jbspgfi64u4h8eo5e7dbiy' }), (attendee:Attendee {id: "0033UGZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: 'f5tcy5gtgzshipr6pag6cn9uski3s8tjare7wd3n7enmyokgjk1o' }), (attendee:Attendee {id: "0033UHZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: 'halfinn1234567890abcdefghijklmnopqrstuvwxyz123' }), (attendee:Attendee {id: "0033UJZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: 'satoshi1234567890abcdefghijklmnopqrstuvwxyz123' }), (attendee:Attendee {id: "0033UKZXVEPNG"})
MERGE (author)-[:AUTHORED]->(attendee);
...
MATCH (author:User { id: 'emq37ky6fbnaun7q1ris6rx3mqmw3a33so1txfesg9jj3ak9ryoy' }), (alarm:Alarm {id: "0033WCZXVEPNG"})
...
MATCH (author:User { id: '8attbeo9ftu5nztqkcfw3gydksehr7jbspgfi64u4h8eo5e7dbiy' }), (alarm:Alarm {id: "0033WDZXVEPNG"})
MERGE (author)-[:AUTHORED]->(alarm);
...
MATCH (author:User { id: 'f5tcy5gtgzshipr6pag6cn9uski3s8tjare7wd3n7enmyokgjk1o' }), (alarm:Alarm {id: "0033WEZXVEPNG"})
MERGE (author)-[:AUTHORED]->(alarm);
...
MATCH (author:User { id: 'halfinn1234567890abcdefghijklmnopqrstuvwxyz123' }), (alarm:Alarm {id: "0033WFZXVEPNG"})
MERGE (author)-[:AUTHORED]->(alarm);
...
MATCH (author:User { id: 'ep441mndnsjeesenwz78r9paepm6e4kqm4ggiyy9uzpoe43eu9ny' }), (alarm:Alarm {id: "0033WGZXVEPNG"})
MERGE (author)-[:AUTHORED]->(alarm);
